...
class Spd_model extends CI_Model {
	...
	var $column = array('nama','namasubkegiatans','tempat','tgl_pergi','tgl_pulang');
	...
	private function _get_datatables_query()
	{
		...
		// $this->db->from($this->table);
            ...
            /*    $this->db->query ('select tsubkegiatans.namasubkegiatans as namasubkegiatans, tsubkegiatans.kota_id as kota, tsubkegiatans.tgl_pergi as tgl_pergi,tsubkegiatans.tgl_pulang as tgl_pulang
                    from tsurat inner join tpegawai on 
                    tsurat.pegawai_id = tpegawai.id inner join tsubkegiatans on 
                    tsurat.subkegiatans_id = tsubkegiatans.id inner join tgolongan on tgolongan.id = tpegawai.golongan_id'); 
     */
            $this->db->select('*');
            $this->db->from('tsurat');
