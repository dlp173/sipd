...
class laporan_model extends CI_Model {
	...
	{
		$this->db->update($this->tlaporan, $data, $where);
...
function sisaanggaran(){

          $query = $this->db->query('select tsatker.satker as satker, tprogram.namaprogram as namaprogram,tkegiatans.namakegiatan as namakegiatan, 
tkegiatans.sisaanggaran as sisaanggaran from tkegiatans inner join tsatker on tkegiatans.satker_id = 
tsatker.idsatker inner join tprogram on tkegiatans.program_id = tprogram.idprogram order by tsatker.satker');
