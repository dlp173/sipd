            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                 <div class="box-header">
                  <h3 class="box-title">    <div class="panel-heading">Detail Informasi Kegiatan   </p> </b></div>    </div><!-- /.box-header -->
                  ...
                  <td> 
                      <a href="<?php echo base_url('index.php/cetaksurattugas/ajax_detail/'  .$data->id) ?>" class="btn btn-primary">Detail Kegiatan</a> 
