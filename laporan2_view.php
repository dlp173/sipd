            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                 <div class="box-header">
                  <h3 class="box-title">        <div class="panel-heading">Laporan Kegiatan  </p> </b></div>  </div><!-- /.box-header -->
                  ...
                  <td> <?php echo $data->namasubkegiatans;?></td>
                      ...
                      if ($data->laporan_id > 0){
                        ...
                        echo "<td><a  href = 'laporan/viewnotadinas/$data->id' class='btn btn-primary' target='_blank's>Print</a> <a  href = 'laporan/ajax_edit/$data->id' class='btn btn-primary'>Edit</a></td>";
                          ...
                          echo " <td><a  href = 'laporan/inputlaporankegiatans/$data->id' class='btn btn-warning'> Input Laporan</td></a>
