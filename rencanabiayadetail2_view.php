    ...
    
{
        ...
        <section class="invoice">
          ...
          <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <i class="fa fa-bank"></i> Mata Anggaran  
              ...
              <div class="col-xs-2 table-responsive"> <input name='pegawai_id' hidden="true" value="<?php echo $data->idpegawai;?>">
               ...
               <div class="col-xs-2 table-responsive"> 
                            <select name="biaya_kegiatan_id" class="form-control" id="kegiatans" >
                                    <option value=0>Select Kegiatan</option>
                            </select> 
		              </div>
                ...
                <div class="col-xs-6 table-responsive"> 
                   ...
                   <select name="" class="c12" id="anggarans" >
          ...
          <div class="row invoice-info">
            ...
            <div class="col-sm-4 invoice-col">
             ...
             </div><!--  <b>Tanggal dibuat</b> : <?php echo tgl_indo(date('Y-m-d'));?> <br>/.col -->
          </div><!-- /.row -->
 ...
 <td>Transport $data->kota - $data->kotatujuan + Bording Pass </td><td> </td><td> </td>  <td> <input class='c7' onkeyup='hitung2();'  name='biayatiketpergi' type='number'   value='0'> </td>
              ...
              <td> <input hidden="true"class="b2" name="hariinap" onkeyup="hitung2();"  type="number"  value=0 />  </td> 
                       ...
                       <td> <input hidden="true"class="a3" name="biayainap" onkeyup="hitung2();"  type="number"  value="<?php echo $data->biayainap;?>" readonly /> </td>
                           ...
                           <tr> 
                               ...
                               {
                                   foreach($getbiayarep as $datarep){
                                 echo " <td>Biaya Representative</td></td><td> </td><td>  <td>  <input class='c5' name='biayarep' value=$datarep->nominal> </td>
                       <td> 
                          </tr> ";
                                   } }else{
          ...
          <div class="row">
            ...
            <div class="col-xs-6">
                <p class="lead">Catatan :  Sisa Anggaran <input class="sisaanggaran" name="sisaanggaran" onkeyup="hitung3();" readonly="true" type="number"  value=0 /> </p>
            ...
            <div class="col-xs-6">
              <p class="lead">Pembayaran Tanggal : <?php echo tgl_indo(date('Y-m-d'));?>  </p>
...
<a href="<?php echo base_url('index.php/rencanabiaya/biayakegiatans/' .$data->idkegiatan);?>" class="btn btn-danger pull-right"> <i class="fa fa-credit-card"></i> Batal</a>
              ...
              <button type="button" id="btnSave" onclick="save()" class="btn btn-primary pull-right" style="margin-right: 5px;" disabled /> <i class="fa fa-save"></i> Simpan</button>
...
function hitung2() {
  ...
  //var totalbiayatiketpulang = parseInt($(".c8").val());
    ...
    var totalbiayainap = parseInt($(".c2").val()); //a kali b
